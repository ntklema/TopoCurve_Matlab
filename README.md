...
The code uses a formal surface theory approach to calculate geometry metrics on gridded DEMs that are not sensitive to projection distortion.
...
relies on the TopoToolbox package for basic processing of geospatial datasets.  Topotoolbox can be downloaded at https://topotoolbox.wordpress.com/download/ and 
