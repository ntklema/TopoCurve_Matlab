...
ClipRange=[4.14e5,4.14e5+5e3,4.82e6,4.82e6+5e3]; 
Filter=[190,200];
kt=0.00001;
...
%% Or could do the same mixing in some high cascades
...
%%  Synthetic surface generated by Leif that superimposes a quadratic basin 
